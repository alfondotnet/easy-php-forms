function addFields()
{
    ...
    {
        var field_html = '<h4>Field '+ (i+1) +'</h4><div class="form-group"><label class="col-sm-2 control-label" for="field_type_'+ (i+1) +'">Type of the field</label><div class="col-sm-10"><select name="field_type_'+ (i+1) +'"><option value="1">text</option><option value="2">textarea</option><option value="3">checkbox</option></select></div>';
